    ...
    <div>
        <form action="FrontController" id="form-page-registration">
            ...
            <div class="table">
                ...
                <div class="tr">
                    <div class="password">
                        <input type="password" id="Password" name="password" size="20" maxlength="25"
                ...
                <div class="tr">
                    <div class="telephone">
                        <input type="text" id="Telephone" name="telephone" size="20" maxlength="25"
                ...
                <div class="tr">
                    <div class="District">
                        <input type="text" id="District" name="district" size="20" maxlength="25"
